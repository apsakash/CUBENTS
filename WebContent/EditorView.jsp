...
<button class="btn btn-default" data-toggle='modal' data-target='#myManual' title="User Manual">User Manual</button>
<div class="modal fade" id="myManual" role="dialog">
    <div class="modal-dialog">
      <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">User Manual : Instructions for User</h4>
        </div>
        <div class="modal-body">
  <div class="tab-content">
   
    <div id="menu1" class="tab-pane fade in active">
      <h3>Project Tree</h3><br><br>
      <b>Accessing : </b> Click on the tree symbol on the top-left of the page to get the project tree.<br>
      <b>Use : </b> The Project tree contains a number of topics . On clicking on any of the topics the related subtopics appear which the User can
      select to open/edit/play the activity/animations.<br><br>
      <hr>
      <h3>Menu Bar : </h3>	
      
      <b>Save Button:</b> opens model to take the topic name and the activity name to save the activity
      <br>
      <b>Drop-down near Save Button:</b> options for creating new activity and creating new group.
      <br>
      <b>copy:</b> to copy an element
      <br>
      <b>paste:</b> to paste an element
      <br>
      <b>Animation:</b> to give animation to the three types of elements
      <br>
      <b>Text:</b> to add new text
      <br>
      <b>Delete Text:</b> to delete text
      <br>
      <b>Shapes:</b> to add shapes
      <br>
      <b>Line:</b> to select solid line or dotted line
      <br>
      <b>delete:</b> to delete graphic element
      <br>
      <b>omega:</b> to add equation 
      <br>
      <b>?:</b> to add hint to an element
      <br>
      <b>i:</b> to view the hint associated with an element
      <br>
      <b>play:</b> to play the animation
      <br>
      <b>user Manual:</b> to view the user Manual<br>
      <hr>
      <h3>Graphics : </h3>
      <b>Accessing</b> : Click on the 'shapes' button which will show a drop down menu.<br><br>
      <b>Availing Options</b> :  Select the shape you want to draw. Choose a stroke weight. Stroke style can be changed from dashed to default using the toggle button marked '---'. Using the 'fill' option to give the shape a fill colour.<br><br> 
      <b>Animating Graphics</b>: On selecting a graphics element and clicking Animate button, a dialogue box pops up. Go to the Graphics tab. One can select animation type from drop down menu. One can also input animation delay and duration.<br><br> 
      <b>Deleting Graphics</b>:Select the graphics element to be deleted and click on the button with a bin icon to delete that element.
      
      <hr>
      <h3>Text : </h3><br><br>
      <b>Accessing</b> : Click on the 'T' button to add a text element to the board.<br><br>
      <b>Availing Options</b>:Double click on the text element to open in-line CKeditor instance.This can be used to format text, add images, GIFs, tables, anchors and many such items.<br><br> 
      <b>Animating Text</b>:On selecting the text and clicking Animate button, a tab opens where one can select animation type from drop down menu. One can also input animation delay and duration.<br><br> 
      <b>Deleting Text</b>:Select a text element and click on the 'T' button with a strike-through to delete a text element.
      <hr>
      <h3>Hints : </h3><br><br>
      <b>Accessing</b> : Click on the '?' button to add a hint to the selected element<br><br>
      <b>Availing Options</b> : Hint can have a brief hint called title, a description and URL option to add links for further reference.<br><br> 
      <b>Previewing hint</b> : On hovering over an element, the title bar will show up and on clicking on the hint button the hint dialogue box will pop up. The link when clicked on will open in a new tab.<br><br> 
      
      <hr>
      <h3>Math Equation Maker : </h3><br><br>
      <b>Accessing</b> : Click on the Omega Symbol to open the Equation Editor.<br><br>
      <b>Availing Options : </b>Click on the avail options button to open the options for creating new
      equations and styling the equations.<br><br>
      <b>New Equation</b> : To make a new equation click on the new Equation button.Then start typing into the 
      text-field provided<br><br>
      <b>Animating Equation : </b>On the main menu bar go to the button named <emp>Animation</emp>. Then navigate to equations and
      set the Animation Order and Animation name.<br><br>
      <b>Modes(TextMode/MathMode) : </b> - TextMode Allows you to go and make any change in the Editor which contains the auto generated code.
      MathMode allows you to enter code with tags being generated on their own. This feature is an editing feature , and can be navigated using the 
      TextMode/MathMode buttons.<br><br>
    </div>	
  </div> 
        </div>
        <div class="modal-footer">
...
//Script to create a new text element, make it draggable and on double click it should be content editable, giving it default attributes and storing it in the array 
    ...
    //            console.log("id matched for init is "+id);
        ...
        //Script for dragging multiple elements
        .drag(function( ev, dd ){
           //   console.log("drag: "+id);
            $( this ).css({
              top: dd.offsetY-Y,
...
//                             console.log("index: "+k+"Xpos: "+MyArray[k].xPos+"Ypos: "+MyArray[k].xPos);
      ...
      var l=txpos;
      var t=typos;
          //Pushing new element in the array with default attributes
     MyArray.push({id:"T"+c,Data:s,in_anim:i,xPos:l,yPos:t,in_delay:"2",in_duration:"3000",animOrder:"1",groupOrder:"0"});
      ...
      //Script to associate an inline CKeditor instance with the current div element 
      CKEDITOR.inline( "T"+c,{});
      c++;
    //Script to be called on single click on a div to make it draggable and add class 'selected'
    function singleClick(e) {
         ...
         T_E=1;//to store flag representing last clicked is equation or text
    ...
    //Script to make div contenteditable on double click
    ...
    //Script to decide between a double click and a single click
      $(x).click(function(e) 
      {
        var that = this;
        setTimeout(function()
